        ...
        this.searchThrottlingTimeout = setTimeout(() => {
            ...
            if (this.cleanSearchTerm.length >= MINIMAL_SEARCH_TERM_LENGTH) {
                ...
                if(this.accountId != null) {
                    const searchEvent = new CustomEvent('searchforaccount', {
                        detail: {
                            searchTerm: this.cleanSearchTerm,
                            selectedIds: this.curSelection.map((element) => element.id),
                ...
                if(this.contractFrameworkId != null) {
                    const searchEvent = new CustomEvent('searchforcontractframework', {
                        detail: {
                            searchTerm: this.cleanSearchTerm,
                ...
                if(this.pricebookEntryId != null) {
                    const searchEvent = new CustomEvent('searchforrelatedassets', {
                        detail: {
                            searchTerm: this.cleanSearchTerm,
                ...
                if(this.accountTreatmentId != null) {
                    const searchEvent = new CustomEvent('searchforcontractpayer', {
                        detail: {
                            searchTerm: this.cleanSearchTerm,
                            accountTreatmentId: this.accountTreatmentId
                        }
                    });
                    this.dispatchEvent(searchEvent);
                }
